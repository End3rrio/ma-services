...
class RecommendationService:
    ...
    def create_recommendation(self, user_id: UUID, recommended_track_id: UUID) -> Recommendation:
        return self.recommendation_repo.create_recommendation(track_id=recommended_track_id, user_id=user_id)
