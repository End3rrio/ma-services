...
class RecommendationRepo:
    ...
    def create_recommendation(self, track_id: UUID, user_id: UUID) -> Recommendation:
        recommendation = Recommendation(id=uuid.uuid4(), user_id=user_id, recommended_track_id=track_id)
